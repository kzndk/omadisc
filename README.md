...
4. The toolbar channel menu follows the active pane. In a server channel it lists the channels Discord has rendered for that server; choose one to open it in the same pane. **Focus pane** temporarily expands a chat and **Back to grid** restores your layout. Use page scale 65% / 80% for dense layouts.
